  ...
  return (
    <section id="testimonials" className="pt-32 pb-20">
      ...
      <div className="md:flex md:justify-between gap-8">
        <motion.div
          className="mx-auto relative bg-blue max-w-[300px] h-[200px] flex flex-col justify-end p-16 mt-32
        ...
        <motion.div
          className="mx-auto relative bg-red max-w-[300px] h-[200px] flex flex-col justify-end p-16 mt-32
        ...
        <motion.div
          className="mx-auto relative bg-yellow max-w-[300px] h-[200px] flex flex-col justify-end p-16 mt-32
